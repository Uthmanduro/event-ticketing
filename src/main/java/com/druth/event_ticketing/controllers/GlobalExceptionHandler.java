...
import com.druth.event_ticketing.domain.dtos.ErrorDto;
import com.druth.event_ticketing.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> handleTicketNotFoundException (TicketNotFoundException ex) {
        ...
        errorDto.setError("Ticket Code not found");
    ...
    public ResponseEntity<ErrorDto> handleTicketSoldOutException (TicketSoldOutException ex) {
        ...
        ErrorDto errorDto = new ErrorDto();
        errorDto.setError("Ticket are Sold out");
        return new ResponseEntity<>(errorDto, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorDto> handleMethodArgumentNotValidException(
        ...
        log.error("Caught Method ArgumentValidException: ", ex);
        ErrorDto errorDto = new ErrorDto();
